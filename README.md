...
- [**vitest-md-reporter**](https://github.com/robertozmc/vitest-md-reporter) — Markdown reporter - ideal for CI pipelines, GitHub Actions job summaries, and AI agents fixing failing tests.
